...
function Info(props) {
    ...
    return (
        ...
        <div className="flex flex-col space-y-5 basis-1/2 items-stretch justify-center py-10 px-10">
        <div className="relative flex flex-col bg-white rounded-xl mx-auto p-4 justify-between space-y-1 shadow-sky-800 shadow-lg w-5/6 ml-0 h-max">
