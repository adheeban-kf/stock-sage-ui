  ...
  return (
    <div style={bgStyle} className="overflow-none">
      <div className="snap-y snap-proximity overflow-auto h-screen w-screen scroll-smooth">
        <NavBar />
        <div
          className="p-4 min-h-screen snap-center shrink-0 bg-black"
          id="slide-1"
        >
        ...
        <div
          className="p-4 min-h-screen snap-center shrink-0 pt-10"
          id="slide-2"
        >
