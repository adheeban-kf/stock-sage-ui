    ...
    return (
        <nav className="bg-transparent">
            <div className="flex flex-row h-16 w-auto p-4 justify-between items-center mx-auto">
                ...
                <div className="flex place-content-end basis-1/2 gap-4 h-full">
                    <svg 
                    className="h-full"
                    ...
                    <button className='bg-emerald-800 text-white text-sm font-sans rounded-md px-4 focus:bg-emerald-900 focus:ring-4 focus:ring-gray-300 focus:border-gray-100'>
                        {"Other Apps "}&darr;
                    </button>
                </div>
            </div>
